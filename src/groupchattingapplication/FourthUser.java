...
public class FourthUser implements ActionListener, Runnable {
    ...
    FourthUser() {
        ...
        JLabel senderStatus = new JLabel("Lucas, Mike, Will, Dustin, Eleven, Steve, Nancy, Max");
        ...
        try {
            ...
            System.out.println("Exception in constructor (FourthUser) : " + e);
            e.printStackTrace();
        }
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        String out = "Lucas : " + message.getText();
        try {
            sendTextToFile(out);
            ...
            System.out.println("Exception in actionPerformed method (FourthUser) : " + e);
            e.printStackTrace();
        }
        message.setText("");
    }
    ...
    public void sendTextToFile(String message) throws FileNotFoundException {
        try (FileWriter file = new FileWriter("chat.txt", true);
            ...
            System.out.println("Exception in sendTextToFile method (FourthUser) : " + e);
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        //new FourthUser().frame.setVisible(true);
        FourthUser user = new FourthUser();
    ...
    public void run() {
        try {
            ...
            System.out.println("Exception in run method (FourthUser) : " + e);
            e.printStackTrace();
        }
    }
}
