...
public class ThirdUser implements ActionListener, Runnable {
    ...
    ThirdUser() {
        ...
        JLabel senderStatus = new JLabel("Dustin, Mike, Will, Lucas, Eleven, Steve, Nancy, Max");
        ...
        try {
            ...
            System.out.println("Exception in constructor (ThirdUser) : " + e);
            e.printStackTrace();
        }
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        String out = "Dustin : " + message.getText();
        try {
            sendTextToFile(out);
            ...
            System.out.println("Exception in actionPerformed method (ThirdUser) : " + e);
            e.printStackTrace();
        }
        message.setText("");
    }
    ...
    public void sendTextToFile(String message) throws FileNotFoundException {
        try (FileWriter file = new FileWriter("chat.txt", true);
            ...
            System.out.println("Exception in sendTextToFile method (ThirdUser) : " + e);
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        //new ThirdUser().frame.setVisible(true);
    ...
    public void run() {
        try {
            ...
            System.out.println("Exception in run method (ThirdUser) : " + e);
            e.printStackTrace();
        }
    }
}
