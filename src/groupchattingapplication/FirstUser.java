...
public class FirstUser implements ActionListener, Runnable {
    ...
    FirstUser() {
        ...
        JLabel senderStatus = new JLabel("Mike, Will, Dustin, Lucas, Eleven, Steve, Nancy, Max");
        ...
        try {
            ...
            System.out.println("Exception in constructor (FirstUser) : " + e);
            e.printStackTrace();
        }
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        String out = "Mike : " + message.getText();
        try {
            sendTextToFile(out);
            ...
            System.out.println("Exception in actionPerformed method (FirstUser) : " + e);
            e.printStackTrace();
        }
        message.setText("");
    }
    ...
    public void sendTextToFile(String message) throws FileNotFoundException {
        try (FileWriter file = new FileWriter("chat.txt", true);
            ...
            System.out.println("Exception in sendTextToFile method (FirstUser) : " + e);
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        //new FirstUser().frame.setVisible(true);
    ...
    public void run() {
        try {
            ...
            System.out.println("Exception in run method (FirstUser) : " + e);
            e.printStackTrace();
        }
    }
}
